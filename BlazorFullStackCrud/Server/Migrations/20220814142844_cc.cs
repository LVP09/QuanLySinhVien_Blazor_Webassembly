        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ki = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaNghanh = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenNghanh = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Nghanhs", x => x.MaNghanh);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lops_Nghanhs_MaNghanh",
                        column: x => x.MaNghanh,
                        principalTable: "Nghanhs",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaSv = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AnhSv = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaDiem = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MonHocMaMh = table.Column<int>(type: "int", nullable: false),
                    SinhViensMaSV = table.Column<int>(type: "int", nullable: false),
                    DiemThi = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Diems_SinhViens_SinhViensMaSV",
                        column: x => x.SinhViensMaSV,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Diems_SinhViensMaSV",
                table: "Diems",
                column: "SinhViensMaSV");
